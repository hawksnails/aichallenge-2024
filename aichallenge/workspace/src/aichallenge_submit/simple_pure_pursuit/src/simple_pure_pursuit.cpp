...
void SimplePurePursuit::onTimer()
{
  ...
  if (closet_traj_point_idx == trajectory_->points.size() - 1 ||
    ...
    RCLCPP_INFO_THROTTLE(get_logger(), *get_clock(), 1000 /*ms*/, "Reached the goal");
  } else {
